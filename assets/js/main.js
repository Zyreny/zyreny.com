...
function loadNav(btns) {
    ...
    const btmNavHTML = btns.map(btn => `<a href="${btn.href}"><li><img src="/assets/img/menu/${btn.id}.svg" alt="${btn.name}圖標" loading="lazy">${btn.name}</li></a>`).join("");

    nav.innerHTML = `
    <header>
        <h1>Zyreny</h1>
        <a href="#"><img src="/assets/img/logo/zyreny_full.svg" alt="Zyreny" loading="lazy"></a>
